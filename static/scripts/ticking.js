...
function snape() {
    ...
    if(isSnape){
        ...
        document.getElementById('snape').classList.remove("inactive");
        return 'snape stop';
    }
    else{
        console.log('snape stop');
        document.getElementById('snape').classList.add("inactive");
        return 'snape';
    }
}
...
function dumbledore() {
    ...
    if(isDumbledore){
        ...
        document.getElementById('dumbledore').classList.remove("inactive");
        return 'dumbledore stop';
    }
    else{
        console.log('dumbledore stop');
        document.getElementById('dumbledore').classList.add("inactive");
        return 'dumbledore';
    }
}
...
function ron() {
    ...
    if(isRon){
        ...
        document.getElementById('ron').classList.remove("inactive");
        return 'ron stop';
    }
    else{
        console.log('ron stop');
        document.getElementById('ron').classList.add("inactive");
        return 'ron';
    }
}
...
function hermione() {
    ...
    if(isHermione){
        ...
        document.getElementById('hermione').classList.remove("inactive");
        return 'hermione stop';
    }
    else{
        console.log('hermione stop');
        document.getElementById('hermione').classList.add("inactive");
        return 'hermione';
    }
}
...
function harry() {
    ...
    if(isHarry){
        ...
        document.getElementById('harry').classList.remove("inactive");
        return 'harry stop';
    }
    else{
        console.log('harry stop');
        document.getElementById('harry').classList.add("inactive");
        return 'harry';
    }
}
...
function voldemort() {
    ...
    if(isVoldemort){
        ...
        document.getElementById('voldy').classList.remove("inactive");
        return 'voldy stop';
    }
    else{
        console.log('voldy stop');
        document.getElementById('voldy').classList.add("inactive");
        return 'voldy';
    }
}
...
function getAudioData(i) {
    ...
    switch (i) {
        case 0:
            file = "static/sounds/tick.mp3";
            break;
        case 1:
            file = "static/sounds/Snape_Long.mp3";
            break;
        case 2:
            file = "static/sounds/Dumbledore.mp3";
            break;
        case 3:
            file = "static/sounds/Ron.mp3";
            break;
        case 4:
            file = "static/sounds/Hermione.mp3"; 
            break;
        case 5:
            file = "static/sounds/Harry.mp3";
            break;
        case 6:
            file = "static/sounds/Voldemort.mp3";
            break;
        case 7:
            file = "static/sounds/SingingThatSong_AllDayLong.mp3";
            break;
        case 8:
            file = "static/sounds/SnapeHarry.mp3";
        default:
            break;
    }
...
function init(){
    ...
    timerWorker = new Worker("static/scripts/metronomeworker.js");
